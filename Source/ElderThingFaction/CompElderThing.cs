...
namespace ElderThingFaction
{
    public class CompElderThing : CompAbilityUser
    {
        ...
        {
            base.PostExposeData();
            Scribe_Values.Look(ref elderThingPowersInitialized, "elderThingPowersInitialized", false);
            Scribe_Values.Look(ref elderThingPowersInitializedRedundant, "elderThingPowersInitializedRedundant", false);
            Scribe_Deep.Look<ElderThingData>(ref elderThingData, "elderThingData", new object[] { this });
        }
    }
}