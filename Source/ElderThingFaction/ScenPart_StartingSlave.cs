...
namespace ElderThingFaction
{
    public class ScenPart_StartingSlave : ScenPart
    {
        ...
        {
            base.ExposeData();
            Scribe_Values.Look<int>(ref count, "count", 0, false);
        }
        ...
        public override void DoEditInterface(Listing_ScenEdit listing)
        {
            ...
            Widgets.TextFieldNumeric<int>(scenPartRect, ref count, ref countBuf, 1f, 10f);
        }
        ...
        {
            var ScenPart_StartingSlave = other as ScenPart_StartingSlave;
        ...
        public override IEnumerable<Thing> PlayerStartingThings()
        {
            ...
            {
                Pawn newSlave = NewGeneratedStartingSlave();
