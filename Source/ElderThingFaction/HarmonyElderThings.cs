                        ...
                        if (p.MapHeld is Map m)
                        {
                            ...
                            if (potentialTargets != null && potentialTargets.Count() > 0)
                            {
                                ...
                                foreach (var target in potentialTargets)
                                {
                                    ...
                                    var flag = verb.TryFindShootLineFromTo(p.Position, target, out ShootLine resultingLine);
                                ...
                                for (var shotsFired = 0; shotsFired < chosenTargets.Count() && shotsFired < 4; shotsFired++)
                                {
                                    ...
                                    var projectile2 = (Projectile)GenSpawn.Spawn(__instance.def, currentLine.Source, p.Map);
